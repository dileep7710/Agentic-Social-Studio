...
IG_USER_ID = os.getenv("INSTAGRAM_ACCOUNT_ID", "17841448994358440")
IG_ACCESS_TOKEN = os.getenv("INSTAGRAM_ACCESS_TOKEN", "")
DEFAULT_WHATSAPP_PHONE = os.getenv("WHATSAPP_DEFAULT_PHONE", "+917710278967")
WATERMARK_NAME = os.getenv("WATERMARK_NAME", "AI Studio")
LINKEDIN_ACCESS_TOKEN = os.getenv("LINKEDIN_ACCESS_TOKEN", "AQUgE2xebTvY1_kAFDY7vdneZ7RQWfIluH2N2pNi1rKUeoeQRwFHQxI8oLCb8RNGg4NHDoWM-3AWGrRkO8Tyn4XEOZyMa6bE0cAA5XvEKSge1pMjbMmJg0PZ46ogp8WttmyIdsdA9MCKh07CgNg6NoX6W0QKhKvBeV8qzjQjvDEkePr8UvnM7wfjAzyJb7scOR5wRMoZLwaPpum6xgv67HAKkFazI_4UCvgQWVuBhNfib1IGc73ZG93bZ_nhuMBJDC6CxDPFhIrELb8FTW-FgW-02R104I5ook0BRvoa61p30X56jCRxawb4hyllpX0XqBNi1D6fylueUB7_16DlDrSNURit3Q")
LINKEDIN_AUTHOR_URN = os.getenv("LINKEDIN_AUTHOR_URN", "urn:li:person:neomMhUioZ")
